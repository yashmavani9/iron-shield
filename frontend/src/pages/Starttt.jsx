...
const Starttt = () => {
  ...
  return (
    <div className='bg-white'>
      ...
      <p className="text-stone-500 xl:px-28 md:px-20 sm:px-14 px-4 mt-80 max-md:mt-60 max-md:text-center"><span className="italic border-b-2 border-stone-500 hover:text-black hover:border-black"><a href="https://yashmavani.framer.website/" target="_blank">Yash Mavani</a></span> Production</p>
